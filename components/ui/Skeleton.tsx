          ...
          {[1, 2, 3].map((i) => (
            ...
            >
              <div className="hero-glass-frame relative w-full backdrop-blur-md">
                ...
                <div className="flex flex-col gap-1.5 overflow-hidden rounded-md border border-primary-500/30 bg-primary-100/75 p-1.5 sm:gap-1.5 sm:p-2 dark:bg-primary-800/30">
